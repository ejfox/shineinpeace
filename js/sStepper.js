...
var i, navLink, options, sStepper, sectionCount, sections, _i, _ref;
...
sStepper.init = function(stepperElement, sStepperOptions) {
...
sStepper.switchTo = function(targetNum) {
  ...
  if (options !== void 0) {
    if (options.callbacks !== void 0) {
      if (options.callbacks['section' + currentStep] !== void 0) {
        exitCallback = options.callbacks['section' + currentStep].exit;
      }
      if (options.callbacks['section' + targetNum] !== void 0) {
